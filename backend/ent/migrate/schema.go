...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "probes", Type: field.TypeJSON, Nullable: true},
		...
		{Name: "sort_order", Type: field.TypeInt64, Nullable: true, Default: schema.Expr("nextval('channel_monitor_sort_order_seq')")},
