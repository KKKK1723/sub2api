...
func SortOrder(v int64) predicate.ChannelMonitor {
...
func SortOrderIsNil() predicate.ChannelMonitor {
	return predicate.ChannelMonitor(sql.FieldIsNull(FieldSortOrder))
}

// SortOrderNotNil applies the NotNil predicate on the "sort_order" field.
func SortOrderNotNil() predicate.ChannelMonitor {
	return predicate.ChannelMonitor(sql.FieldNotNull(FieldSortOrder))
}
