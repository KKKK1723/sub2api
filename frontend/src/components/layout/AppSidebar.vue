<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      >
        <img v-if="settingsLoaded" :src="siteLogo || '/logo-cat.png'" alt="Logo" class="h-full w-full object-contain" />
      </router-link>
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/ai-products', label: t('nav.aiProducts'), icon: GiftIcon },
    ...
    { path: '/available-models', label: t('nav.availableModels'), icon: ChartIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/upstream-balances', label: t('nav.upstreamBalances'), icon: CreditCardIcon },
