export default {
    accounts: {
      ...
      upstreamBalance: {
        columnHint: 'The upstream site supplies this balance for reference. The API key stays on the backend and is used only for same-origin requests.',
        enabled: 'Query upstream balance',
        enabledHint: 'Queries immediately when the account is saved, then refreshes on the global upstream probe interval.',
        preset: 'Endpoint preset',
        presets: {
          sub2api: 'CC Switch compatible / Sub2API (GET /v1/usage)',
          custom: 'Custom'
        },
        method: 'Request method',
        authType: 'Authentication',
        url: 'Query URL',
        urlHint: 'Only URLs on the account Base URL origin are allowed. Base URL and origin template variables are supported.',
        balancePath: 'Balance field path',
        unitPath: 'Currency field path',
        planPath: 'Plan field path',
        errorPath: 'Error field path',
        totalPath: 'Total field path',
        usedPath: 'Used field path',
        validPath: 'Validity field path',
        defaultUnit: 'Default currency',
        ...
        stale: 'Stale',
        ok: 'Current',
        probeFailed: 'Failed to query upstream balance'
      },
      ...
      openai: {
        ...
        compatibleProviderDesc: 'The provider selects URL, model, and protocol presets while using the OpenAI-compatible transport.',
        providerZhipu: 'Zhipu GLM',
        providerCustom: 'Custom compatible service',
        responsesModeDesc:
