export default {
    accounts: {
      ...
      upstreamBalance: {
        columnHint: '余额由上游站点返回，仅供参考。API Key 仅由后端用于同源请求，不会发送到浏览器。',
        enabled: '查询上游余额',
        enabledHint: '启用后，保存账号时立即查询，并按全局上游探测周期自动刷新。',
        preset: '接口预设',
        presets: {
          sub2api: 'CC Switch 兼容 / Sub2API（GET /v1/usage）',
          custom: '自定义'
        },
        method: '请求方法',
        authType: '认证方式',
        url: '查询地址',
        urlHint: '仅允许与账号 Base URL 同源；支持 Base URL 和站点源地址模板变量。',
        balancePath: '余额字段路径',
        unitPath: '币种字段路径',
        planPath: '套餐字段路径',
        errorPath: '错误字段路径',
      ...
      openai: {
        ...
        compatibleProvider: 'OpenAI 兼容供应商',
        compatibleProviderDesc: '供应商决定默认地址、模型预设和协议模式；底层仍使用 OpenAI 兼容协议。',
        providerZhipu: '智谱 GLM',
        providerCustom: '自定义兼容服务',
        responsesModeDesc:
